    ...
    if (selectedScreen.equals("/accountHist")) { 
      ...
      if ( (fromAccountId == null) || (toAccountId == null) ) { 
        ...
        try { 
          ...
          transferBean.setTransferAmount((new BigDecimal(request.getParameter("transferAmount"))).setScale(2)); 
      ...
      try { 
        ...
        atmBean.setAmount((new BigDecimal(request.getParameter("amount"))).setScale(2)); 
