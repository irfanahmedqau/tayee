    ...
    public BeanManager() { 
      ...
      if (acctctl == null) { 
         try { 
            ...
            Debug.print("Unable to lookup home: " + CodedNames.ACCOUNT_CONTROLLER_EJBHOME  + ex.getMessage()); 
         } 
      } 
       if (txctl == null) { 
         try { 
            ...
            Debug.print("Couldn't create transaction bean."  + ex.getMessage()); 
         } catch (CreateException ex) { 
            Debug.print("Couldn't create transaction bean."  + ex.getMessage()); 
         } catch (NamingException ex) { 
            Debug.print("Unable to lookup home: " + CodedNames.TX_CONTROLLER_EJBHOME  + ex.getMessage()); 
         } 
      } 
    } 
