...
<div id="pageHeader">
  <div style="padding:10px 0 0 0"><a href="/homepage.html"><img src="${contextPath}/images/logo.gif" /></a></div>
  <div style="position:absolute; margin:-60px 0 0 360px;">
    <div class="navSearchWrap">
      <div class="navSeachPart">
        <div class="searchPanel">
          <div class="panelLBg"><img src="${contextPath}/images/seachArea_Bg_L.gif" /></div>
          <div class="panelM">
            ...
            <div class="searchButton"><a href="javascript:void(0)"><img src="${contextPath}/images/seachArea_btn.gif" border="0" /></a></div>
          </div>
          <div class="panelRBg"><img src="${contextPath}/images/seachArea_Bg_R.gif" /></div>
        </div>
