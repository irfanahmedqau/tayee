...
public class AccountHistoryBean { 
   private BigDecimal credits, debits, beginningBalance, endingBalance; 
   private String accountId; 
   private int date, activityView, sortOption; 
   private int sinceMonth, sinceDay, beginMonth, beginDay, endMonth, endDay, year; 
   ...
   public void doTx() { 
     ...
     Date endDate = null; 
      try { 
         switch (date) { 
            case 0: 
              startDate = com.sun.ebank.util.DateHelper.getDate(year, sinceMonth, sinceDay); 
              endDate = new Date(); 
              break; 
            case 1: 
              startDate = com.sun.ebank.util.DateHelper.getDate(year, beginMonth, beginDay); 
              endDate = com.sun.ebank.util.DateHelper.getDate(year, endMonth, endDay); 
              break; 
         } 
            ...
            while (i.hasNext()) { 
              ...
              if (isCreditAcct) { 
                  ...
                  if (amount.floatValue() > 0) { 
                    ...
                    Debug.print("Subtracting " + amount + "from debits."); 
                    debits = debits.subtract(amount); 
                  } 
               } 
            } 
